...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(../src/media/bg/bg-2.jpg);">
  <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
    <div class="kt-login__container">
      <div class="kt-login__logo">
        <a href="#">
          <img src="../src/media/logos/logo-5.png">
        </a>
      </div>
      <div class="kt-login__signin">
        ...
        <form class="kt-form" action="{{ route('admin.login') }}" method="post">
          ...
          <div class="kt-login__actions">
            ...
            <input type="submit" name="submit" class="btn btn-brand btn-pill kt-login__btn-primary" value="Sign In">
