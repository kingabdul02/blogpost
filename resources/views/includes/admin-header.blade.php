...
<!--begin: Notifications -->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
            <form>
                <!--begin: Head -->
    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url({{$baseUrl}}/src/media/misc/bg-1.jpg)">
...
<!--end: Notifications --><!--begin: Quick Actions -->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
            <form>
                <!--begin: Head -->
    <div class="kt-head kt-head--skin-dark" style="background-image: url({{$baseUrl}}/src/media/misc/bg-1.jpg)">
        <h3 class="kt-head__title">
            User Quick Actions
...
<div class="kt-header__topbar-item dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
        <form>
            <!-- begin:: Mycart -->
<div class="kt-mycart">
            <div class="kt-mycart__head kt-head" style="background-image: url({{$baseUrl}}/src/media/misc/bg-1.jpg);">
    ...
    <div class="kt-mycart__body kt-scroll ps" data-scroll="true" data-height="245" data-mobile-height="200" style="height: 245px; overflow: hidden;">
        <div class="kt-mycart__item">
            <div class="kt-mycart__container">
                ...
                <a href="#" class="kt-mycart__pic">
                    <img src="{{$baseUrl}}/src/media/products/product9.jpg" title="">
                </a>
            </div>
        </div>
        ...
        <div class="kt-mycart__item">
            <div class="kt-mycart__container">
                ...
                <a href="#" class="kt-mycart__pic">
                    <img src="{{$baseUrl}}/src/media/products/product13.jpg" title="">
                </a>
            </div>
        </div>
        ...
        <div class="kt-mycart__item">
            <div class="kt-mycart__container">
                ...
                <a href="#" class="kt-mycart__pic">
                    <img src="{{$baseUrl}}/src/media/products/product16.jpg" title="">
                </a>
            </div>
        </div>
        ...
        <div class="kt-mycart__item">
            <div class="kt-mycart__container">
                ...
                <a href="#" class="kt-mycart__pic">
                    <img src="{{$baseUrl}}/src/media/products/product15.jpg" title="" alt="">
                </a>
            </div>
        </div>
    <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
...
<div class="kt-header__topbar-item kt-header__topbar-item--langs">
    ...
    <li class="kt-nav__item kt-nav__item--active">
        <a href="#" class="kt-nav__link">
            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo1/dist/assets/media/flags/226-united-states.svg" alt=""></span>
            <span class="kt-nav__link-text">English</span>
        </a>
    </li>
    <li class="kt-nav__item">
        <a href="#" class="kt-nav__link">
            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo1/dist/assets/media/flags/128-spain.svg" alt=""></span>
            <span class="kt-nav__link-text">Spanish</span>
        </a>
    </li>
    <li class="kt-nav__item">
        <a href="#" class="kt-nav__link">
            <span class="kt-nav__link-icon"><img src="https://keenthemes.com/metronic/themes/metronic/theme/default/demo1/dist/assets/media/flags/162-germany.svg" alt=""></span>
...
<div class="kt-header__topbar-item kt-header__topbar-item--user">
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
            ...
            <img class="kt-hidden" alt="Pic" src="{{$baseUrl}}/src/media/users/300_25.jpg">
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
        <!--begin: Head -->
    <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url({{$baseUrl}}/src/media/misc/bg-1.jpg)">
